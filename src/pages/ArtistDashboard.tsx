...
import { Music, Calendar, MapPin, MessageSquare, Settings, Plus, LogOut } from 'lucide-react';
import { format } from 'date-fns';
import { TravelDate, BookingRequest, Artist, BOOKING_STATUS_LABELS } from '@/types/database';
